//=================CALCULATE amountOfEachRecipe TO GET TO P3 RECIPE=================
// let listTransaction = [
//   {
...
//=================ADD WHERE INGREDIENT USE IN RECIPE============================
// const ingredients = [
//   {
...
const favorite = [
  {
    user_id: "63763fe0458a1834b44f0972",
    recipe_id: "6375e683366df22200ae01a1",
  },
  {
    user_id: "63763fe0458a1834b44f0972",
    recipe_id: "63837a0eafb2432184e0526e",
  },
];
...
for (const [index, recipe] of recipes.entries()) {
  ...
  for (favoriteRecipe of favorite) {
    if (recipe._id === favoriteRecipe.recipe_id) {
